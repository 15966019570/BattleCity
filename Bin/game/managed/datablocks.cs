$managedDatablockSet = new SimSet() {
   ...
   new t2dImageMapDatablock(battleCityTextImageMap) {
      imageName = "~/data/images/battleCityText.png";
      imageMode = "FULL";
      frameCount = "-1";
      filterMode = "SMOOTH";
      filterPad = "1";
   ...
   new t2dImageMapDatablock(tankImageMap) {
      imageName = "~/data/images/tank.png";
      imageMode = "FULL";
      frameCount = "-1";
      filterMode = "SMOOTH";
      filterPad = "1";
